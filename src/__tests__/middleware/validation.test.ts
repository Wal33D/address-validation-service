...
import { validate, validateLocationRequest, schemas } from '../../middleware/validation';
...
describe('Validation Middleware', () => {
    ...
    describe('validate middleware factory', () => {
        it('should pass valid data', () => {
            ...
            mockReq.body = { lat: 40.7128, lng: -74.0060 };

            middleware(mockReq as Request, mockRes as Response, mockNext);

            expect(mockNext).toHaveBeenCalledWith();
            expect(mockReq.body).toEqual({ lat: 40.7128, lng: -74.0060 });
        });

        it('should throw ValidationError for invalid data', () => {
            const middleware = validate(schemas.coordinates);
            mockReq.body = { lat: 'invalid', lng: -74.0060 };
    ...
    describe('validateLocation schema', () => {
        ...
        it('should validate geo coordinates', () => {
            mockReq.body = {
                ...
                geo: {
                    type: 'Point',
                    coordinates: [-74.0060] // Missing one coordinate
                }
            };
    ...
    describe('coordinates schema', () => {
        it('should validate US territory bounds', () => {
            const testCases = [
                ...
                { lat: 40.7128, lng: -74.0060, shouldFail: false }, // Valid NYC
